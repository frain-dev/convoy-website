...
-  `--native`: This flag specifies if the `native` realm should be enabled. You can read more about the native realm [here](https://getconvoy.io/docs/deployment/configuration#configuration-reference) It is a boolean flag. Defaults to `false`.
