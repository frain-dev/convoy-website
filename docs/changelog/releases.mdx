...
- **Advanced Signatures**: We've updated the signature implementation in Convoy to parse both [simple and advanced signatures](/product-manual/signatures). You can configure the type of signature send advanced signatures in your webhook request headers to Convoy.
