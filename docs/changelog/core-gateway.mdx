...
<Update label="25.9.1">
    ...
    - Release 25.9.1 introduces Google SSO, dependency and Docker updates, logging and RBAC improvements, circuit breaker configuration refactor, enhanced batch retries, and a fix for internal error handling.
</Update>
