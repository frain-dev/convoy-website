...
This is Convoy native metrics that enable you observe the internal state of the data plane from the ingestion pipeline to the delivery pipeline. See [Metrics](/product-manual/metrics) and [Grafana-oriented operations](/product-manual/metrics#grafana-and-dashboards).
