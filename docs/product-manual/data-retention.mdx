...
'og:title': Data Retention
'og:description': Data retention ships older webhook data to S3 compatible cold storage.
'twitter:description': Data retention ships older webhook data to S3 compatible cold storage.
'twitter:url': https://docs.getconvoy.io/product-manual/data-retention
---
