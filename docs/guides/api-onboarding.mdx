...
`POST /api/v1/projects/{projectID}/onboard` creates endpoints and matching subscriptions in bulk inside a project you already have. It does not replace the full org → project → sources graph above — use it after your project exists.
...
For load and capacity validation after onboarding, see [Load testing and benchmarks](/guides/load-testing-and-benchmarks).
