...
<Note>
**Sizing Guidance:** For standard production deployments, the recommended starting point is **1 vCPU (1000m)** and **2GB of RAM (2000Mi)** per container replica. Both the Server and Agent are stateless and can be horizontally scaled.
</Note>
