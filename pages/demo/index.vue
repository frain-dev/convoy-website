<template>
	<div>
		...
		<!-- demo -->
		<section id="demo" class="bg-[url(~/assets/images/demo.png)] bg-no-repeat bg-cover bg-top min-h-[80vh] w-full">
			<div class="flex justify-center items-center flex-col text-white-100 py-100px desktop:py-130px">
