<template>
    <NuxtLayout name="home">
        <div class="px-20px bg-gradient-to-br from-[#2c2f3e] to-[#422f41]">
...
let earlyAccessEmail = ''
const tabs = [
    { label: 'Open Core', id: 'open' },
    { label: 'App Portal', id: 'portal' }
]
const activeTab = 'open'
const appPortal = ['Manage multiple endpoints', 'Debug **event logs**', 'Embed into your UI', 'SDK']
const openCore = ['Team management', 'Mulitple projects', 'Debug logs and metric', 'Manage app and customers']
const features = [
    {
        feature: 'Secure',
...
const activeSlide = true
const expandImage = false

function switchTabs(activeTab: string) {
    switch (activeTab) {
        case 'cloud':
            activeTab = 'cloud';
            break;
...
async function requestAccess() {
    isSubmitingloadingEarlyAccessForm = true;
    try {
        ...
        subscribeButtonText = 'Error';
        setDefaultAccessButtonText();
        isSubmitingloadingEarlyAccessForm = false;
    }
}

function setDefaultAccessButtonText() {
    setTimeout(() => {
