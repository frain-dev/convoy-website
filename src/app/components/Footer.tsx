							...
							<div className="flex flex-col-reverse nav-bar-break:flex-col justify-between flex-wra desktop:pb-40px desktop:block bor der w-full xl-old:w-min mobile:gap-10 bor der !hi dden">
								<div className="flex justify-between items-start desktop:justify-end bor der desktop:gap-100px w-full gap-y-10 desktop: flex-wrap pb-42px desktop:footer:block xl-old:w-max">
									{footerLinks.map((section, index) => (
										<div key={index} className="mobile:w-[150px]">
							...
							<div className="flex flex-col">
								...
								<ul className="flex">
									<li className="bg-opacity-10 hover:opacity-75 transition-all w-42px h-42px flex items-center justify-center mr-16px last-of-type:mr-[unset]">
										<a aria-label="View Convoy on GitHub" rel="noopener noreferrer" target="_blank" href="https://github.com/frain-dev/convoy">
									...
									<li className="bg-opacity-10 hover:opacity-75 transition-all w-42px h-42px flex items-center justify-center mr-16px last-of-type:mr-[unset]">
										<a aria-label="View Convoy on LinkedIn" rel="noopener noreferrer" target="_blank" href="https://www.linkedin.com/company/convoy-webhooks/">
											<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
												<path
									...
									<li className="bg-opacity-10 hover:opacity-75 transition-all w-42px h-42px flex items-center justify-center mr-16px last-of-type:mr-[unset]">
										<a aria-label="View Convoy on Email" rel="noopener noreferrer" target="_blank" href="mailto:sales@getconvoy.io">
											<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
												<path
									...
									<li className="bg-opacity-10 hover:opacity-75 transition-all w-42px h-42px flex items-center justify-center mr-16px last-of-type:mr-[unset]">
										<a
											aria-label="View Convoy on Slack"
									...
									<li className="bg-opacity-10 hover:opacity-75 transition-all w-42px h-42px flex items-center justify-center mr-16px last-of-type:mr-[unset]">
										<a aria-label="View Convoy on Twitter" rel="noopener noreferrer" target="_blank" href="https://twitter.com/getconvoy">
											<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
												<path
