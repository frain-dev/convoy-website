const Toast = () => {
	return (
		<div id="toast" className="border flex items-center gap-12px p-12px max-w-[420px] w-full rounded-8px fixed transition-all duration-300 z-[100] bottom-100px -right-[450px]" role="alert">
