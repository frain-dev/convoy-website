...
export default function CodeBlock({ children, file, language }: CodeBlockProps) {
	...
	return (
		<div className="border border-[#111111] rounded-8px mb-32px bg-[#111111] api">
			{file && <div className="py-8px px-12px rounded-tl-8px rounded-tr-8px text-12 text-white-100 bg-[#535251]">{file}</div>}
