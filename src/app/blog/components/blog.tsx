						...
						<div>
							...
							<ul className="flex">
								<li className="bg-gray-400 bg-opacity-10 w-42px h-42px flex items-center justify-center rounded-[50%] mr-16px last-of-type:mr-[unset]">
									<Link target="_blank" href="https://join.slack.com/t/convoy-community/shared_invite/zt-xiuuoj0m-yPp~ylfYMCV9s038QL0IUQ">
								...
								<li className="bg-gray-400 bg-opacity-10 w-42px h-42px flex items-center justify-center rounded-[50%] mr-16px last-of-type:mr-[unset]">
									<Link target="_blank" href="https://twitter.com/getconvoy">
										<img src="/svg/twitter-grey-icon.svg" alt="twitter logo" />
									</Link>
								</li>
								<li className="bg-gray-400 bg-opacity-10 w-42px h-42px flex items-center justify-center rounded-[50%] mr-16px last-of-type:mr-[unset]">
									<Link target="_blank" href="https://github.com/frain-dev/convoy">
						...
						<div className="relative">
							...
							{showCategories && (
								<ul className="absolute bg-white-100 shadow-sm rounded-10px p-24px z-1 w-216px mt-4px">
									{tags.map((tag, i) => (
										<li key={i} className="mb-32px last-of-type:mb-0 text-14 text-gray-600">
