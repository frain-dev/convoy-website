...
import { useCases, type UseCase } from '../data';
		...
		<main className="bg-[#fafafa]">
			...
			<section className="pt-[100px] pb-12 desktop:pt-[137px] desktop:pb-[57px]">
				<div className="max-w-[1280px] m-auto flex flex-col items-start desktop:items-center px-20px">
					<motion.div {...fadeUp} className="flex flex-col items-start desktop:items-center w-full">
						...
						<p className="max-w-[683px] desktop:mx-auto desktop:text-center desktop:text-16 text-14 leading-[160%] text-[#666] mt-2 desktop:mt-16px">
			...
			<section className="w-full max-w-[1280px] mx-auto px-4 mobile:px-6 desktop:px-8 pb-24px desktop:pb-72px">
				<motion.div {...fadeUp} className="mb-10 desktop:mb-14">
					<h2 className="text-24 desktop:text-32 font-semibold mb-3">{useCase.painPointsHeading}</h2>
					<p className="text-[#666] text-14 desktop:text-16 leading-[160%] max-w-[700px]">
						{useCase.painPointsSubheading}
					</p>
				</motion.div>
			...
			<section className="w-full max-w-[1280px] mx-auto px-4 mobile:px-6 desktop:px-8 pb-24px desktop:pb-72px">
				<motion.div {...fadeUp} className="mb-10 desktop:mb-14">
					<h2 className="text-24 desktop:text-32 font-semibold mb-3">{useCase.featuresHeading}</h2>
					<p className="text-[#666] text-14 desktop:text-16 leading-[160%] max-w-[700px]">
						{useCase.featuresSubheading}
					</p>
				</motion.div>
				...
				<section className="w-full max-w-[1280px] mx-auto px-4 mobile:px-6 desktop:px-8 pb-24px desktop:pb-72px">
					<motion.div
						...
						<div className="flex flex-col gap-5 items-start">
							...
							<p className="text-14 desktop:text-20 leading-[160%] desktop:leading-[140%] text-[#666]">&ldquo;{useCase.testimonial.quote}&rdquo;</p>
