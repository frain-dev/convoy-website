					...
					{useCases.map((uc, i) => (
						<motion.div
							...
							<Link
								...
								<div className="flex flex-col gap-2 p-5 desktop:p-6 flex-1">
									<div className="flex items-center gap-3 mb-1">
										...
										<h2 className="text-18 desktop:text-20 font-semibold text-[#000] group-hover:text-[#2780F1] transition-colors">{uc.title}</h2>
									</div>
									<p className="text-14 leading-[180%] text-[#4B4B4B]">{uc.description}</p>
								</div>
