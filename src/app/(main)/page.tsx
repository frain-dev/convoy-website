...
export default function Home() {
	...
	return (
		<main className="flex flex-col items-center pb-120px w-full">
			<section className="pt-150px px-20px flex items-center flex-col max-w-[1180px] w-full">
				<h1 className="text-center font-medium text-[40px] desktop:text-[40px] mb-24px max-w-[683px] m-auto">
					Reliable open-source <br />
					webhooks for Efficient Engineers
				</h1>
				<p className="text-center text-[#666] text-14 desktop:text-16 max-w-[683px] m-auto mb-24px font-medium">
				...
				<div className="w-full shadow-video bg-white-100 border border-[#e7e7e7] rounded-8px h-[600px] flex items-center justify-center">
					<Image src={playButton} alt="play" className="cursor-pointer" />
				</div>
			</section>

			<section className="py-80px">
				<div className="w-[1180px] overflow-hidden relative">
					<div className="w-80px h-40px bg-gradient-to-r from-[#fafafa] to-transparent bo rder absolute left-0 top-0 z-20" />
					<div className="w-80px h-40px bg-gradient-to-l from-[#fafafa] to-transparent bo rder absolute right-0 top-0 z-20" />
					<div className="slideshow h-40px">
			...
			<section className="flex flex-col gap-20 max-w-[1180px] w-full my-10">
				<div className="w-full flex">
					<h2 className="text-[40px] font-medium w-[502px]">The World’s Most Advanced Webhooks Gateway</h2>
				</div>
				<div className="flex gap-[60px]">
					<div className="flex flex-col gap-3">
						<h4 className="text-20 font-semibold leading-[150%]">Advanced Endpoint Management</h4>
						<p className="text-16 leading-[150%] text-[#666] w-[378px]">
					...
					<div className="w-[742px] h-[360px] pt-10 pl-10 bor der overflow-hidden rounded-t-16px" style={{ backgroundImage: `url(${frame.src})` }}>
						<div className="bg-white-100 h-full w-full rounded-tl-8px"></div>
					</div>
				</div>
				...
				<div className="flex gap-[60px]">
					<div className="flex flex-col gap-3">
						<h4 className="text-20 font-semibold leading-[150%]">Unparalleled Developer Experience</h4>
						<p className="text-16 leading-[150%] text-[#666] w-[378px]">
				...
				<div className="flex gap-[60px]">
					<div className="flex flex-col gap-3">
						<h4 className="text-20 font-semibold leading-[150%]">Highly Reliable Architecture</h4>
						<p className="text-16 leading-[150%] text-[#666] w-[378px]">
			...
			<section className="flex items-center">
				<div className="bg-white-100 rounded-8px gap-60px my-20 p-10 border border-[#e7e7e7] flex flex-col max-w-[1180px] w-full">
					<div className="flex flex-col items-center gap-3">
						<h2 className="text-[40px] font-medium text-center">Customer Remarks</h2>
						<p className="text-[#666] text-center text-16 leading-[150%]">Read what our customers have to say about Convoy</p>
					</div>

					<div className="flex flex-col gap-10 items-center">
						<div className="flex gap-5 bo rder w-full">
							<div className="min-w-[47.5%] bor der pr-5 pb-28px flex flex-col gap-5 items-start">
								<Image src={neynar} height={30} width={150} alt="logo" quality="70" className="h-28px w-auto" />
								<p className="text-20 leading-[140%] text-[#666] w-full">
								...
								<div className="flex items-center gap-2">
									...
									<div className="flex flex-col gap-1">
										<h5 className="font-semibold text-16 leading-4">Manan Patel</h5>
										<p className="text-[#666] text-[13px] font-medium leading-4">CTO at Neynar, Ex Coinbase</p>
									</div>
								</div>
							</div>

							<div className="bg-[#e7e7e7] w-[1px] min-h-full -[302px]" />

							<div className="min-w-[47.5%] bor der flex pl-5 pb-28px flex-col gap-5 items-start">
						...
						<div className="bg-[#e7e7e7] w-full min-h-[1px]" />

						<div className="flex gap-5 bor der w-full">
							<div className="min-w-[340px] [47.5%] bor der flex pb-58px flex-col gap-5 items-start">
								<Image src={marble} height={30} width={150} alt="logo" quality="70" className="h-28px w-auto" />
								<p className="text-16 w-[316px] h-[140px] leading-[150%] text-[#666]">
								...
								<div className="flex items-center gap-2">
									...
									<div className="flex flex-col gap-1">
										<h5 className="font-semibold text-16 leading-4">Pascal Delange</h5>
										<p className="text-[#666] text-[12px] font-medium leading-4">CTO at Marble, Ex-Director of Engineering, Shine</p>
									</div>
								</div>
							</div>

							<div className="bg-[#e7e7e7] min-w-[1px] min-h-full -[302px]" />
							...
							<div className="min-w-[340px] [47.5%] bor der flex pb-58px flex-col gap-5 items-start">
								...
								<div className="flex items-center gap-2">
									...
									<div className="flex flex-col gap-1">
										<h5 className="font-semibold text-16 leading-4">Jonathan Wiemer</h5>
										<p className="text-[#666] text-[12px] font-medium leading-4">Lead Software Engineer, Source.ag</p>
									</div>
								</div>
							</div>

							<div className="bg-[#e7e7e7] min-w-[0.5px] min-h-full" />
							...
							<div className="min-w-[340px] [47.5%] bor der flex pb-58px flex-col gap-5 items-start">
								...
								<div className="flex items-center gap-2">
									...
									<div className="flex flex-col gap-1">
										<h5 className="font-semibold text-16 leading-4">Aravindkumar Rajendiran</h5>
			...
			<section className="flex items-center justify-center w-full">
				<div className="gap-60px my- 20 flex flex-col max-w-[1180px] w-full items-center">
					<div className="flex flex-col items-center gap-6">
						<h2 className="text-[40px] w-[436px] font-medium text-center">Security, Scalability and Compliance</h2>
						<p className="text-[#666] w-[512px] text-center text-16 leading-[150%]">
							We take security and reliability seriously. Our platform complies with security standards you need to run your business.
						</p>
					</div>

					<div className="flex items-center justify-between w-full [1180px]">
						<ul className="flex flex-col gap-5 list-none">
							<li className="flex gap-2.5 items-center">
								...
								<p className="text-20 font-semibold leading-[150%]">SOC2 Compliant</p>
							</li>
							...
							<li className="flex gap-2.5 items-center">
								...
								<p className="text-20 font-semibold leading-[150%]">GDPR Compliant</p>
							</li>
							...
							<li className="flex gap-2.5 items-center">
								...
								<p className="text-20 font-semibold leading-[150%]">SSO & SAML</p>
							</li>
							...
							<li className="flex gap-2.5 items-center">
								...
								<p className="text-20 font-semibold leading-[150%]">Private Networking</p>
							</li>
							...
							<li className="flex gap-2.5 items-center">
								...
								<p className="text-20 font-semibold leading-[150%]">99.999% uptime SLA.</p>
							</li>
							...
							<li className="flex gap-2.5 items-center">
								...
								<p className="text-20 font-semibold leading-[150%]">Role-based access control.</p>
							</li>
						</ul>

						<div className="w-[720px] h-[360px] rounded-16px bg-gradient-to-b from-[#2780F11A] to-[#fafafa]"></div>
					</div>
				</div>
			</section>
		</main>
