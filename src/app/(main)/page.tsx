		...
		<main>
			<section className="max-w-[1062] flex flex-col justify-center items-center pt-220px pb-100px px-20px">
				<div className="bg-primary-25 rounded-[40px] w-fit py-10px px-20px flex items-center text-14 mb-40px">
					We are backed by
					<Image src="/svg/y-combinator.svg" width={24} height={24} className="ml-16px w-24px"
						   alt="y-combinator"/>
				</div>
				<h1 className="text-center desktop:text-[50px] desktop:leading-[80px] font-bold">Reliable open-source
					webhooks for</h1>
				<h1 className="text-center desktop:text-[50px] desktop:leading-[80px] font-bold text-primary-400">Efficient
					Engineers</h1>
				<p className="text-center max-w-[950px] mx-auto text-16 leading-8 mobile:text-14 mt-16px text-gray-600">
					Securely Send, Receive and Manage millions of Webhooks Reliably with robust support for Retries,
					Rate Limiting, Static IPs, Circuit Breaking, Rolling Secrets
					and more.
				</p>
				<div className="flex justify-center xs:flex-col mt-40px">
					...
					<Link
						...
						<Image src="/svg/documentation.svg" height={16} width={16} className="mr-10px w-16px"
							   alt="document icon"/>
						Documentation
					</Link>
				</div>
			...
			<section className="max-w-[700px] m-auto px-20px">
			...
			{/*<section*/}
			{/*	className="bg-[url(/static/convoy-bg.png)] index-animation-min:bg-[length:100%] bg-[length:150%] bg-no-repeat bg-center px-20px">*/}
			{/*	<div*/}
			{/*		className="rounded-12px bg-white-8 backdrop-blur-[10px] border border-[#F9FBFE] p-20px desktop:p-30px max-w-[1085px] w-full m-auto">*/}
			{/*		<img src="/static/dashboard.png" alt="convoy dashboard"*/}
			{/*			 className="border border-gray-100 rounded-8px"/>*/}
			{/*	</div>*/}
			{/*</section>*/}
			...
			<section id="why-convoy" className="flex flex-col justify-center items-center pt-160px">
				<div className="bg-primary-25 rounded-[40px] w-fit py-10px px-20px flex items-center text-14 mb-40px">
					<div
						className="mr-16px w-24px h-24px rounded-100px bg-success-400 flex justify-center items-center">
				...
				<div className="desktop:py-40px px-20px feature-list">
					{newFeatures.slice(0, 3).map((feature, i) => (
						<div
							className="flex flex-col desktop:flex-row items-center justify-between max-w-[1236px] mx-auto mb-140px feature gap-x-20 gap-y-10"
							key={i}>
							...
							<div className="md:max-w-[500px] tab:max-w-[470px] tab:ml-20px order-1 desktop:order-2">
								<img src={`/static/${feature.featureImg}.png`} alt={`${feature.featureImg} image`}
			...
			<section className="py-60px desktop:py-110px">
				<div className="max-w-[1170px] w-full m-auto px-20px">
					<div
						className="bg-gradient-to-br from-[#2c2f3e] to-[#422f41] rounded-16px pt-40px px-20px pb-100px desktop:px-66px desktop:pt-50px desktop:pb-200px">
						...
						<div className="w-full min-h-[280px] h-full">
							...
							<div
								...
								<h1 className="text-32 desktop:text-[40px] desktop:leading-[60px] text-white-100 font-bold text-center">Enterprise
									Edition</h1>
								<p className="text-white-100 text-center text-14 leading-7 desktop:mt-16px max-w-[860px] m-auto">
									Send & Receive billions of webhooks while totally control your own event
									infrastructure and data, and staying compliant all with one platform
									with on-prem support .
								</p>

								<div
									className="flex justify-center desktop:justify-center m-auto mobile:overflow-x-scroll mobile:scroll-smooth no-scrollbar mt-30px desktop:mt-40px w-full">
							...
							<div
								...
								<h1 className="text-32 desktop:text-[40px] desktop:leading-[60px] text-white-100 font-bold text-center">Convoy
									Cloud</h1>
								<p className="text-white-100 text-center text-14 leading-7 mt-20px desktop:mt-16px max-w-[860px] m-auto">
									Fully managed Webhooks-as-a-service platform where you can manage millions of
									webhook events whether incoming or outgoing and you only pay for
									what you use.
								</p>
							...
							<div
								...
								<h1 className="text-32 desktop:leading-[60px] text-white-100 font-bold text-center">Community
									Edition</h1>
								<p className="text-white-100 text-center text-14 leading-7 mt-20px desktop:mt-16px max-w-[860px] m-auto">
									Open-source Webhooks Gateway for managing incoming and outgoing webhooks. Ships with
									everything you need for securely sending and receiving
									events reliably.
								</p>
					...
					<div
						className="bg-[#082B91] bg-opacity-[0.07] w-11/12 h-220px desktop:h-270px rounded-b-16px m-auto relative">
						<div
							className="absolute left-1/2 -translate-x-1/2 -top-100px xs:-top-70px desktop:-top-200px w-full">
							<div className="md:max-h-320px max-h-[218px] overflow-hidden rounded-16px w-fit mx-auto">
								<img src="/static/groups-img-small.png" alt="group"
									 className="xs:hidden max-w-[866px] desktop:w-full w-5/6 m-auto"/>
							</div>
							<img src="/static/groups-img-small.png" className="hidden xs:block m-auto w-5/6"
								 alt="group"/>
			...
			<section className="bg-[#fcfcfc] py-60px desktop:py-80px px-24px desktop:px-64px">
				<div className="max-w-[1234px] mx-auto">
					<h2 className="font-bold desktop:text-32 mb-22px">
						Developers use Convoy Webhooks Gateway to securely ingest, persist, debug, deliver and manage
			...
			<section className="max-w-[1234px] mx-auto pt-60px px-20px desktop:pt-180px pb-60px desktop:pb-116px">
				<div className="bg-primary-25 rounded-[40px] w-fit py-10px px-20px flex items-center text-14 mb-40px">
					<div
						className="mr-16px w-24px h-24px rounded-100px bg-warning-400 flex justify-center items-center">
						<svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								d="M13.5749 6.95841C13.5056 6.82098 13.3997 6.70541 13.2688 6.62451C13.1379 6.54361 12.9871 6.50054 12.8332 6.50008H8.66655V1.50008C8.67549 1.31731 8.62403 1.13669 8.52011 0.986077C8.41619 0.835467 8.26559 0.723249 8.09155 0.666743C7.92424 0.611696 7.74379 0.611077 7.5761 0.664976C7.40842 0.718875 7.26212 0.824519 7.15822 0.966743L0.491551 10.1334C0.408023 10.2541 0.357867 10.3948 0.34616 10.5411C0.334453 10.6874 0.361611 10.8343 0.424885 10.9667C0.483153 11.1182 0.584375 11.2493 0.716126 11.3441C0.847877 11.4388 1.00442 11.493 1.16655 11.5001H5.33322V16.5001C5.33335 16.6758 5.38903 16.847 5.4923 16.9892C5.59557 17.1314 5.74114 17.2373 5.90822 17.2917C5.99194 17.3177 6.07891 17.3317 6.16655 17.3334C6.29804 17.3338 6.42774 17.303 6.54506 17.2436C6.66237 17.1842 6.76397 17.0979 6.84155 16.9917L13.5082 7.82508C13.598 7.70074 13.6517 7.55404 13.6635 7.40112C13.6753 7.24821 13.6446 7.09502 13.5749 6.95841ZM6.99988 13.9334V10.6667C6.99988 10.4457 6.91209 10.2338 6.75581 10.0775C6.59953 9.92121 6.38756 9.83341 6.16655 9.83341H2.83322L6.99988 4.06674V7.33341C6.99988 7.55442 7.08768 7.76638 7.24396 7.92267C7.40024 8.07895 7.6122 8.16674 7.83322 8.16674H11.1666L6.99988 13.9334Z"
								fill="#FCFCFC"
				...
				<h1 className="desktop:text-[48px] desktop:leading-[60px] font-bold max-w-[842px]">All-in-one Webhooks
					Gateway for all your event needs</h1>
			</section>
