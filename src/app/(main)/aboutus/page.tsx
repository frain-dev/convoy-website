...
export default function AboutUs() {
	...
	return (
		<main>
			<section className="max-w-[1062] flex flex-col justify-center desktop:items-center pt-100px desktop:pt-150px pb-70px desktop:pb-80px px-20px">
				<div className="bg-[#2780F1]/[0.1] rounded-[6px] w-fit py-10px px-12px flex items-center text-14 font-medium mb-40px">
					We are backed by
					<a href="https://www.ycombinator.com/companies/convoy-2">
				...
				<ul className="flex gap-16px mt-40px">
					<a href="https://github.com/frain-dev/convoy" target="_blank">
						<li className="w-32px h-32px bg-[#2780F1]/[0.1] bg-opacity-10 flex items-center justify-center rounded-[50%]">
			...
			<section className="w-full px-20px m-auto py-24 bg-[#Fff] flex desktop:items-center justify-center">
				<div className="desktop:max-w-[900px] w-full">
					...
					<div className="grid xs:grid-cols-1 sm-old:grid-cols-2 tab-min:grid-cols-2 gap-60px tab-min:gap-40px justify-center items-center m-auto w-full">
			...
			<section className="bg-[#FFF]">
				<div className="max-w-[1233px] px-20px m-auto pt-30px lg-old:pt-70px pb-150px bg-[#FFF]">
					<h2 className="text-24 desktop:text-[32px] font-medium leading-[150%] text-[#000] desktop:text-center mb-20">Backed by Industry leaders</h2>
					...
					<div className="grid grid-cols-1 sm-old:grid-cols-2 md-old:grid-cols-3 xl-old:grid-cols-4 gap-60px desktop:gap-110px">
						{backedLeaders.map((leader, i) => (
							<div className="flex flex-col justify-center items-center text-16 text-center" key={i}>
