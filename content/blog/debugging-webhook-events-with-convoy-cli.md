...
In our initial implementation of a client-side CLI, we noticed issue that raised some questions on the CLI beng intuitive and how to use it. Since then, we decided to take a different approach to improve the UX. Shedding more light on the issues:
